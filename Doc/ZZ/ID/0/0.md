...
Letterhead=<center><b>{Name.Full}</b></center><br><table width="100%"><tr><td width="30%">{From.Name.Full}<br>{From.Title}</td><td width="40%"></td><td width=30%>{Adr.1/2}<br>{Phone}<br>{Domain.Com}</td></tr></table>
